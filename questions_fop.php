			...
			<div class="container">
				...
				<div class="envelope">
					<div class="form-nav">
						...
						<ul class="black-nav">
							<li>
								<a href="#">Підприємство</a>
							</li>
							<li>
								<a href="#" class="active">ФОП</a>
							</li>
						</ul>
					</div>
					<form>
						<div class="row">
							...
							<div class="col-xl-4 col-lg-4 col-md-6">
								<div class="form-wrapper-default">
									<div class="form-group">
										<span>ІПН</span>
										<input type="text" name="thirdname" class="form-control" placeholder="00 00 00 00 00" required="">
									</div>
								</div>
							</div>
							<div class="col-12">
								<p class="form-title">Контактна особа</p>
								<label class="check js-other-person">Інша особа
									<input type="checkbox">
									<span class="checkmark"></span>
								</label>
							</div>
							<div class="col-xl-4 col-lg-4 col-md-6 hidden-col">
								<div class="form-wrapper-default">
									<div class="form-group">
										<span>Прізвище </span>
										<input type="text" name="surname" class="form-control" placeholder="Ваше прізвище" required="">
